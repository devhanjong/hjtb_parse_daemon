...
public class CoinParseService {
    ...
    public ResponseEntity<?> streamHogaParse(String kafkaMessage){
        try {
//            log.info("message :: " + kafkaMessage);
            ...
            String redisKeyTime = streamHogaDto.getVaspSimpleName() + "::" + streamHogaDto.getMySymbol() + "::time";
            ...
            updateRedisData(redisKey, redisKeyTime, streamHogaDto, kafkaMessage, parseTime);
        } catch (JsonProcessingException e) {
    ...
    private void messagePayloadParse(StreamHogaDto streamHogaDto) throws JsonProcessingException {
        ...
        if(vaspSimpleName.equalsIgnoreCase(BINANCE)){
            DepthResponseBinance depthResponseBinance = mapper.readValue(message, DepthResponseBinance.class);
            streamHogaDto.setBids(depthResponseBinance.getBids());
            streamHogaDto.setAsks(depthResponseBinance.getAsks());
        }
    ...
    private void updateRedisData(String redisKey, String redisKeyTime, StreamHogaDto streamHogaDto, String kafkaMessage, LocalDateTime parseTime) throws JsonProcessingException {
        String vaspSimpleName = streamHogaDto.getVaspSimpleName();
